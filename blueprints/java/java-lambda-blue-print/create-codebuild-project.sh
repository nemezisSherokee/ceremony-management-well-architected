...
STACK_NAME=$(pwd |  awk -F "/" '{print $NF}')-cicd
...
--parameters  ParameterKey=PathToConsider,ParameterValue=blueprints/java/java-lambda-blue-print	ParameterKey=ProjectName,ParameterValue=$PROJECT_NAME \
